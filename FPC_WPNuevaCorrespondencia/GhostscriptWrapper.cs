...
namespace FPC_WPNuevaCorrespondencia
{
    public class GhostscriptWrapper
    {
        ...
        [DllImport(@"c:\Program Files\gs\gs8.64\bin\gsdll32.dll", EntryPoint = "gsapi_new_instance")]
        private static extern int CreateAPIInstance(out IntPtr pinstance, IntPtr caller_handle);

        [DllImport(@"c:\Program Files\gs\gs8.64\bin\gsdll32.dll", EntryPoint = "gsapi_init_with_args")]
        private static extern int InitAPI(IntPtr instance, int argc, string[] argv);

        [DllImport(@"c:\Program Files\gs\gs8.64\bin\gsdll32.dll", EntryPoint = "gsapi_exit")]
        private static extern int ExitAPI(IntPtr instance);

        [DllImport(@"c:\Program Files\gs\gs8.64\bin\gsdll32.dll", EntryPoint = "gsapi_delete_instance")]
            ...
            int height)
        {
            ...
            pageSize.Native = FPC_WPNuevaCorrespondencia.Settings.GhostscriptPageSizes.letter;
            s.Size = pageSize;
    ...
    public class GhostscriptSettings
    {
        ...
        private Settings.GhostscriptPages _pages = new FPC_WPNuevaCorrespondencia.Settings.GhostscriptPages();
        private System.Drawing.Size _resolution;
        private Settings.GhostscriptPageSize _size = new FPC_WPNuevaCorrespondencia.Settings.GhostscriptPageSize();
...
namespace FPC_WPNuevaCorrespondencia.Settings
{
    /// <summary>
