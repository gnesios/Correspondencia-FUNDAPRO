...
{
    public class FormNuevaCorrespondenciaEP_SC : WebPart
    {
        //const string LISTA_OBJETIVO = "Correspondencia de Entrada Educa-Pro (SC)";
        //const string LISTA_REDIRIGIDA = "/Lists/Correspondencia%20de%20Entrada%20EducaPro%20SC/";
        const string PAGINA_IMPRESION = "/_layouts/PaginasFPC/printEP_SC.aspx?";
