...
{
    public class FormNuevaCorrespondenciaFP : WebPart
    {
        //const string LISTA_OBJETIVO = "Correspondencia de Entrada Funda-Pro";
        //const string LISTA_REDIRIGIDA = "/Lists/Correspondencia%20de%20Entrada%20FundaPro/";
        const string PAGINA_IMPRESION = "/_layouts/PaginasFPC/printFP.aspx?";
