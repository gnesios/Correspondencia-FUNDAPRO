...
{
    public class FormNuevaCorrespondenciaEP : WebPart
    {
        //const string LISTA_OBJETIVO = "Correspondencia de Entrada Educa-Pro";
        //const string LISTA_REDIRIGIDA = "/Lists/Correspondencia%20de%20Entrada%20EducaPro/";
        const string PAGINA_IMPRESION = "/_layouts/PaginasFPC/printEP.aspx?";
        //linea 369 RecuperarDocumentosEP
        ...
        void btnFinalizarRegistro_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                {
                    //this.Page.Response.Redirect(ConectorWebPart.RecuperarURLDeLista(LISTA_OBJETIVO));
